...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,(function (){var x__7617__auto__ = tiltontec.webmx.gen.make_tag.call(null,"input",new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id),cljs.core.str.cljs$core$IFn$_invoke$arity$1("box")].join(''),new cljs.core.Keyword("tiltontec.webmx.html","type","tiltontec.webmx.html/type",-686122626),"checkbox",new cljs.core.Keyword(null,"onchange","onchange",1355467329),((function (_STAR_par_STAR_23155,me__$1,cell,slot_name,cache){
return (function (e){
goog.events.Event.preventDefault(e);

return tiltontec.model.core.mswap_BANG__GT_.call(null,me__$1,new cljs.core.Keyword(null,"on?","on?",-74017086),((function (_STAR_par_STAR_23155,me__$1,cell,slot_name,cache){
return (function (p1__23151_SHARP_){
return cljs.core.not.call(null,p1__23151_SHARP_);
});})(_STAR_par_STAR_23155,me__$1,cell,slot_name,cache))
);
});})(_STAR_par_STAR_23155,me__$1,cell,slot_name,cache))
,new cljs.core.Keyword(null,"checked","checked",-50955819),tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol(null,"<mget","<mget",-285244545,null),cljs.core.list(new cljs.core.Symbol(null,"mx-par","mx-par",2020993659,null),new cljs.core.Symbol(null,"me","me",1501524834,null)),new cljs.core.Keyword(null,"on?","on?",-74017086))),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (_STAR_par_STAR_23155,me__$1,cell,slot_name,cache){
...
return cljs.core._conj.call(null,(function (){var x__7617__auto____$1 = (cljs.core.truth_(label_text)?tiltontec.webmx.gen.make_tag.call(null,"label",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"for","for",-1323786319),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id),cljs.core.str.cljs$core$IFn$_invoke$arity$1("box")].join(''),new cljs.core.Keyword(null,"style","style",-496642736),"margin-left:0.5em",new cljs.core.Keyword(null,"onclick","onclick",1297553739),((function (x__7617__auto__,_STAR_par_STAR_23155,me__$1,cell,slot_name,cache){
return (function (e){
goog.events.Event.preventDefault(e);

return tiltontec.model.core.mswap_BANG__GT_.call(null,me__$1,new cljs.core.Keyword(null,"on?","on?",-74017086),((function (x__7617__auto__,_STAR_par_STAR_23155,me__$1,cell,slot_name,cache){
return (function (p1__23152_SHARP_){
return cljs.core.not.call(null,p1__23152_SHARP_);
});})(x__7617__auto__,_STAR_par_STAR_23155,me__$1,cell,slot_name,cache))
);
});})(x__7617__auto__,_STAR_par_STAR_23155,me__$1,cell,slot_name,cache))
], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for cFkids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),new cljs.core.Symbol(null,"label-text","label-text",73559146,null))),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (x__7617__auto__,_STAR_par_STAR_23155,me__$1,cell,slot_name,cache){
return (function (slot_c_SHARP___$1){
var me__$2 = tiltontec.cell.base.c_model.call(null,slot_c_SHARP___$1);
var cell__$1 = slot_c_SHARP___$1;
var slot_name__$1 = tiltontec.cell.base.c_slot.call(null,slot_c_SHARP___$1);
...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,(function (){var x__7617__auto____$1 = label_text;
