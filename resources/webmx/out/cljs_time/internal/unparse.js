...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__28879 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__28879){
return (function (p1__28878_SHARP_){
return cljs.core.subs.call(null,p1__28878_SHARP_,(0),(3));
});})(G__28879))
,G__28879);
} else {
return G__28879;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__28888){
var vec__28889 = p__28888;
var t = cljs.core.nth.call(null,vec__28889,(0),null);
var pattern = cljs.core.nth.call(null,vec__28889,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__28892 = pattern;
switch (G__28892) {
case "S":
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28892)].join('')));
...
switch (G__28902__$1) {
case "millis":
return ((function (G__28902,G__28902__$1){
return (function (p1__28894_SHARP_){
return p1__28894_SHARP_.getMilliseconds();
});
;})(G__28902,G__28902__$1))

break;
case "seconds":
return ((function (G__28902,G__28902__$1){
return (function (p1__28895_SHARP_){
return p1__28895_SHARP_.getSeconds();
});
;})(G__28902,G__28902__$1))
...
return p1__28896_SHARP_.getMinutes();
});
;})(G__28902,G__28902__$1))
...
return p1__28897_SHARP_.getHours();
});
;})(G__28902,G__28902__$1))
...
return p1__28898_SHARP_.getHours();
});
;})(G__28902,G__28902__$1))
...
return p1__28899_SHARP_.getDate();
});
;})(G__28902,G__28902__$1))
...
return p1__28900_SHARP_.getMonth();
});
;})(G__28902,G__28902__$1))
...
return p1__28901_SHARP_.getYear();
});
;})(G__28902,G__28902__$1))

break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28902__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__28904){
...
var key = first__28907;
var args = seq__28906__$1;
var G__28908 = key;
...
break;
case "ordinal-suffix":
var vec__28909 = syntax_list.call(null,(i - (1)));
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28908__$1)].join('')));
...
var d = value;
var G__28916 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
...
var unparser = first__28919;
var more = seq__28918__$1;
var s = "";
var d__$1 = d;
...
while(true){
var d__$2 = d__$1;
var vec__28920 = G__28916__$1;
var seq__28921 = cljs.core.seq.call(null,vec__28920);
var first__28922 = cljs.core.first.call(null,seq__28921);
var seq__28921__$1 = cljs.core.next.call(null,seq__28921);
var unparser__$1 = first__28922;
var more__$1 = seq__28921__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__28923 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__28923,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__28923,(1),null);
var G__28926 = d__$3;
var G__28927 = more__$1;
var G__28928 = s__$3;
d__$1 = G__28926;
G__28916__$1 = G__28927;
s__$1 = G__28928;
continue;
}
break;
