...
var m__7442__auto__ = (bide.core._navigate[goog.typeOf(x__7441__auto__)]);
if(!((m__7442__auto__ == null))){
return m__7442__auto__.call(null,_,loc,params,query);
} else {
var m__7442__auto____$1 = (bide.core._navigate["_"]);
if(!((m__7442__auto____$1 == null))){
return m__7442__auto____$1.call(null,_,loc,params,query);
} else {
...
var x__7441__auto__ = (((_ == null))?null:_);
var m__7442__auto__ = (bide.core._replace[goog.typeOf(x__7441__auto__)]);
if(!((m__7442__auto__ == null))){
return m__7442__auto__.call(null,_,loc,params,query);
} else {
var m__7442__auto____$1 = (bide.core._replace["_"]);
if(!((m__7442__auto____$1 == null))){
return m__7442__auto____$1.call(null,_,loc,params,query);
} else {
...
var x__7441__auto__ = (((_ == null))?null:_);
var m__7442__auto__ = (bide.core._repr[goog.typeOf(x__7441__auto__)]);
if(!((m__7442__auto__ == null))){
return m__7442__auto__.call(null,_);
} else {
var m__7442__auto____$1 = (bide.core._repr["_"]);
if(!((m__7442__auto____$1 == null))){
...
var vec__29033 = cljs.core.vec.call(null,bide.impl.router.match(router,path));
var name = cljs.core.nth.call(null,vec__29033,(0),null);
var params = cljs.core.nth.call(null,vec__29033,(1),null);
var query = cljs.core.nth.call(null,vec__29033,(2),null);
...
return cljs.core.reduce.call(null,(function (router,p__29036){
var vec__29037 = p__29036;
var path = cljs.core.nth.call(null,vec__29037,(0),null);
var name = cljs.core.nth.call(null,vec__29037,(1),null);
return bide.impl.router.insert(router,path,name);
 ...
 */
bide.core.start_BANG_ = (function bide$core$start_BANG_(router,p__29043){
...
var opts = map__29044__$1;
var on_navigate = cljs.core.get.call(null,map__29044__$1,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908));
var default$ = cljs.core.get.call(null,map__29044__$1,new cljs.core.Keyword(null,"default","default",-1987822328));
var html5_QMARK_ = cljs.core.get.call(null,map__29044__$1,new cljs.core.Keyword(null,"html5?","html5?",-1008298421),false);
var html5history = cljs.core.get.call(null,map__29044__$1,new cljs.core.Keyword(null,"html5history","html5history",-1921478143));
...
var _on_navigate = ((function (default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function bide$core$start_BANG__$__on_navigate(event){
var vec__29049 = _match.call(null,event.token);
var name = cljs.core.nth.call(null,vec__29049,(0),null);
var params = cljs.core.nth.call(null,vec__29049,(1),null);
var query = cljs.core.nth.call(null,vec__29049,(2),null);
return on_navigate.call(null,name,params,query);
});})(default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;
var _match = ((function (default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function bide$core$start_BANG__$__match(token){
var result = bide.core.match.call(null,router,token);
var or__6772__auto__ = result;
...
;
var _initial_token = ((function (default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
var or__6772__auto__ = cljs.core.apply.call(null,bide.core.resolve,router,default$__$1);
if(cljs.core.truth_(or__6772__auto__)){
return or__6772__auto__;
} else {
return "/";
...
var history = (cljs.core.truth_(html5_QMARK_)?(function (){var G__29052 = html5history__$1;
G__29052.setPathPrefix("");

G__29052.setUseFragment(false);

G__29052.setEnabled(true);

return G__29052;
})():(function (){var G__29053 = html5history__$1;
G__29053.setUseFragment(true);

G__29053.setEnabled(true);
...
var x29054 = router;
x29054.close = ((function (x29054,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (){
var _ = this;
goog.events.unlistenByKey(lkey);

return history.setEnabled(false);
});})(x29054,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;

x29054.bide$core$IRouter$ = cljs.core.PROTOCOL_SENTINEL;

x29054.bide$core$IRouter$_navigate$arity$4 = ((function (x29054,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
x29054.bide$core$IRouter$_replace$arity$4 = ((function (x29054,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__29044,map__29044__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (_,id,params,query){
var ___$1 = this;
var temp__4657__auto__ = bide.core.resolve.call(null,router,id,params,query);
if(cljs.core.truth_(temp__4657__auto__)){
