...
var _STAR_par_STAR_23985 = tiltontec.model.core._STAR_par_STAR_;
...
var _STAR_par_STAR_23987 = tiltontec.model.core._STAR_par_STAR_;
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_23987;
}});})(_STAR_par_STAR_23985,me__$1,cell__$1,slot_name__$1,cache__$1,_STAR_par_STAR_23984,_STAR_depender_STAR_23983,me,cell,slot_name,cache))
));
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__7615__auto__);
})())));
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_23985;
}});})(_STAR_par_STAR_23984,_STAR_depender_STAR_23983,me,cell,slot_name,cache))
))], null);
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_23984;
}}finally {tiltontec.cell.base._STAR_depender_STAR_ = _STAR_depender_STAR_23983;
}})));
});
...
return tiltontec.webmx.gen.make_tag.call(null,"div",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"color-input"], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for cFkids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),"Time color: ",cljs.core.list(new cljs.core.Symbol(null,"input","input",-2097503808,null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"timecolor","timecolor",709788352),new cljs.core.Keyword("tag","type","tag/type",1175433270),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.list(new cljs.core.Symbol(null,"cI","cI",480228135,null),"#000"),new cljs.core.Keyword(null,"onchange","onchange",1355467329),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__23988#","p1__23988#",1672741570,null)], null),cljs.core.list(new cljs.core.Symbol(null,"mset!>","mset!>",-1433510611,null),cljs.core.list(new cljs.core.Symbol(null,"evt-tag","evt-tag",-675015094,null),new cljs.core.Symbol(null,"p1__23988#","p1__23988#",1672741570,null)),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.list(new cljs.core.Symbol(null,"target-value","target-value",1545084325,null),new cljs.core.Symbol(null,"p1__23988#","p1__23988#",1672741570,null))))], null)))),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),(function (slot_c_SHARP_){
var me = tiltontec.cell.base.c_model.call(null,slot_c_SHARP_);
var cell = slot_c_SHARP_;
var slot_name = tiltontec.cell.base.c_slot.call(null,slot_c_SHARP_);
var cache = tiltontec.cell.base.c_value.call(null,slot_c_SHARP_);
...
var _STAR_par_STAR_23989 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me;
...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core._conj.call(null,(function (){var x__7615__auto__ = tiltontec.webmx.gen.make_tag.call(null,"input",new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"timecolor","timecolor",709788352),new cljs.core.Keyword("tag","type","tag/type",1175433270),"text",new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.core.cI.call(null,"#000"),new cljs.core.Keyword(null,"onchange","onchange",1355467329),((function (_STAR_par_STAR_23989,me,cell,slot_name,cache){
return (function (p1__23988_SHARP_){
return tiltontec.model.core.mset_BANG__GT_.call(null,tiltontec.webmx.gen.evt_tag.call(null,p1__23988_SHARP_),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.webmx.gen.target_value.call(null,p1__23988_SHARP_));
});})(_STAR_par_STAR_23989,me,cell,slot_name,cache))
], null),cljs.core.PersistentArrayMap.EMPTY,null);
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__7615__auto__);
})(),"Time color: "))));
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_23989;
}})));
});
